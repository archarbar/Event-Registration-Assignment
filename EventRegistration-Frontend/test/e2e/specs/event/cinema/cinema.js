...
module.exports = {
  'Test Create Cinema': function (client) {
    const event = {
      movie: 'Avengers',
      name: 'Cinema 1',
    ...
    client
      ...
      .assert.visible(config.id.movieInput)
      .setValue(config.id.movieInput, event.movie)
      ...
      .pause(config.time.pause)
      .assert.containsText(`#${id_name}-movie`, event.movie)
  ...
  'Test Create Existing Cinema': function (client) {
    const event = {
      movie: 'Avengers',
      name: 'Cinema 1',
      date: {day: '10', month: '10', year: '2030'},
  ...
  'Test Create Cinema Empty Time': function (client) {
    const event = {
      movie: 'Avengers',
      name: 'Cinema 2',
      date: {day: '10', month: '10', year: '2030'}
